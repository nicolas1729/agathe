...
import fr.ibp.config.audit.AuditEventConverter;
import fr.ibp.domain.PersistentAuditEvent;
...
import static fr.ibp.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
